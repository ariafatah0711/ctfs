    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="px-4 py-2.5 bg-pink-500/10 hover:bg-pink-500/20 text-pink-600 dark:text-pink-400 border border-pink-500/20 font-bold text-sm rounded-lg shadow-sm flex items-center gap-2 group transition-all"
        >
