      ...
      >
        <span
          className={cn(
            ...
            isTopActive ? 'w-11 shrink-0' : 'flex-1 px-2'
          )}
        >
        ...
        >
          ...
          {isTopActive && <span className="truncate">Global</span>}
        </span>
      </button>
    </div>
  )
