...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-gray-200/80 bg-white/70 text-gray-900 shadow-sm backdrop-blur-xl dark:border-gray-700/80 dark:bg-[#111622]/80 dark:text-gray-100",
      className
    )}
    {...props}
  />
